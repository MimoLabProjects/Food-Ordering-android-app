package com.mimolabprojects.fudy.Common;
...
import com.mimolabprojects.fudy.Callback.MyButtonClickListener;
...
public abstract class MySwiperHlelper extends ItemTouchHelper.SimpleCallback {
    ...
    public MySwiperHlelper (Context context, RecyclerView recyclerView, int buttonWidth)
    {
    ...
    public class MyButton{
        ...
        public void onDraw(Canvas c, RectF rectF, int pos)
        {
            ...
            if (imageResId ==0)//if its Just text
            {
    ...
    public abstract void instantiateMyButton (RecyclerView.ViewHolder viewHolder,List<MyButton> buff);
}
