...
import com.mimolabprojects.fudy.Adapter.MyCommentAdapter;
import com.mimolabprojects.fudy.Callback.ICommentCallBackListener;
        ...
        FirebaseDatabase.getInstance().getReference(Common.COMMENT_REF)
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onCancelled(@NonNull DatabaseError databaseError) {
                        ...
                        listener.onCommentLoadFailed(databaseError
                        .getMessage());
                    }
                });
    }
