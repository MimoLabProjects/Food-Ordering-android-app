...
import com.mimolabprojects.fudy.Adapter.MyCategoriesAdapter;
import com.mimolabprojects.fudy.Common.Common;
import com.mimolabprojects.fudy.Common.SpacesItemDecoration;
...
public class MenuFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        menuViewModel.getCategoryListMtable().observe(this, categoryModelList -> {
            dialog.dismiss();
